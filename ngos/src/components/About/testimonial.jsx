...
// import './styles/swiper.css';  // Import Swiper-specific styles
  ...
  const testimonials = [
    {
      ...
      text: 'Global Green’s innovative approach is transforming communities and fostering real change for a sustainable future."',
    },
    {
      id: 2,
      name: 'Harsh P.',
      ...
      text: "Their commitment to integrating people, planet, and profit is inspiring. A true leader in sustainability.",
    },
    {
      id: 3,
      name: 'Alex K.',
     ...
     text: "Global Green's mission to safeguard our planet’s future is both powerful and necessary for future generations."
    ...
    <section className="py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-14 flex flex-col justify-center items-center sm:flex-row sm:items-center sm:justify-between max-sm:gap-8">
          <h2 className="text-4xl text-center font-bold  lg:text-left">Testimonials</h2>
          <div className="flex gap-8">
            <button id="slider-button-left" className=" group flex justify-center items-center border border-solid border-main4 w-12 h-12 transition-all duration-500 rounded-full hover:bg-indigo-600">
            ...
            <button id="slider-button-right" className=" group flex justify-center items-center border border-solid border-main4 w-12 h-12 transition-all duration-500 rounded-full hover:bg-indigo-600">
              <svg className="h-6 w-6 text-indigo-600 group-hover:text-white" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <SwiperSlide key={testimonial.id}>
              <div className="swiper-slide group bg-white border border-solid border-gray-300 rounded-2xl p-6 transition-all duration-500 w-full hover:border-indigo-600">
                ...
                <div className="flex items-center gap-5">
                  <img className="rounded-full object-cover" src={testimonial.image} alt="avatar" />
