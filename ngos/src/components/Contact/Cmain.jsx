      ...
      <div className="  mx-auto max-w-5xl py-8">
        ...
        <div className="py-5 px-2 text-main3">
          ...
          <div className="grid grid-cols-1 gap-16  lg:grid-cols-2 py-8 ">
            ...
            <div>
              <div className="text-3xl font-bold text-[#004b23] ">
                Phone Number
              </div>
              <div className="text-xl py-4   ">0592400229 / 0551698607</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-[#004b23]">Mail</div>
              <div className="text-xl py-4    ">globallygreeen@gmail.com</div>
            </div>
          </div>
        </div>
      </div>
