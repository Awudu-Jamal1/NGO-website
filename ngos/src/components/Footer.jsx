...
function Footer() {
    ...
    <footer id="ct" className=" px-6   lg:px-8 bg-text1 shadow-lg py-4 text-main">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-2 gap-y-16  border-gray-200   lg:mx-0 lg:max-w-none lg:grid-cols-3">
            ...
            <div
              ...
              className="text-center  text-[0.75rem] tracking-wide text-white "
            >
              <h1 className="font-bold text-[0.8rem]">Contact Us</h1>
            ...
            <div
              className="flex  text-[0.75rem] max-w-xl  flex-col items-center justify-between"
            >
              <h1 className=" font-bold text-[0.8rem] text-white">Follow Us On</h1>

              <div className="py-2  w-48">
                <div className=" grid grid-cols-2 cursor-pointer gap-0 px-9 py-2">
                <div className="icons8-facebook" ></div>
                <div className="text-white pointer ">Globally Green</div>
                </div>
                <div className="grid grid-cols-2 cursor-pointer gap-1 px-9 py-2">
                <div className="icons8-instagram"></div>
                <div className="  text-white ">globallygreen_</div>
                </div>
              </div>
            </div>
